...
<script src="<?php echo base_url()?>my-assets/js/admin_js/customer.js" type="text/javascript"></script> -->
...
<div class="content-wrapper">
	<section class="content-header">
	    ...
	    <div class="header-title">
	        <h1><?php echo display('invoice_sell') ?></h1>
	        <small><?php echo display('invoice_sell') ?></small>
	        <ol class="breadcrumb">
	    ...
	    <div class="row">
            <div class="col-sm-12">
                    ...
                    if($this->permission1->method('add_medicine','create')->access()) { ?>
                        <a href="<?php echo base_url('Cdatalinkage')?>" class="btn btn-info m-b-5 m-r-2"><i class="ti-plus"> </i><?php echo display('add_product')?></a>
                    <?php } ?>
		        ...
		        <div class="panel panel-bd lobidrag">
		            ...
		            <div class="panel-body">
		                <div class="table-responsive">
		                     <table class="table table-striped table-bordered" cellspacing="0" width="100%" id="invoice_sell_information">
		                        <thead>
									<tr>
										<th><?php echo display('sl') ?></th>
										<th><?php echo display('bill_code') ?></th>
										<th><?php echo display('bill_code_QG') ?></th>
										<th><?php echo display('base_code') ?></th>
										<th><?php echo display('medicine_code_QG') ?></th>
										<th><?php echo display('seller_name') ?></th>
										<th><?php echo display('customer_name') ?></th>
										<th><?php echo display('vote_number') ?></th>
									    <th><?php echo display('total_money') ?></th>
										<th><?php echo display('result') ?></th>
										<th width="130px"><?php echo display('action') ?></th>
										<th><?php echo display('button') ?></th>
									</tr>
								</thead>
								<tbody>
