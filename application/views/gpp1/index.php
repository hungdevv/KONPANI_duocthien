		            ...
		            <div class="panel-body">
		                <div class="table-responsive">
		                    <table class="table table-striped table-bordered" cellspacing="0" width="100%" id="PurList"> 
								<thead>
									<tr>
										<th rowspan="2"><?php echo display('sl') ?></th>
										<th rowspan="2"><?php echo display('in4_date') ?></th>
										<th rowspan="2"><?php echo display('in4_address') ?></th>
										<th rowspan="2"><?php echo display('in4_doctor') ?></th>
										<th colspan="3"><?php echo display('in4_sick') ?></th>
